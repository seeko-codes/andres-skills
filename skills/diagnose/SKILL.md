...
10. **HITL bash script.** Last resort. If a human must click, give them a copy of `scripts/hitl-loop.template.sh` to run in their own terminal so the loop is still structured. They paste the captured output back to you.
